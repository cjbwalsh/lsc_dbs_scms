...
The calculations were conducted in R using a series of functions in the file "code/BACRIfunctions.R".  The code chunk below loads BACRIfunctions.R and the data. 
...
```{r, include=TRUE, fig.align="center", echo=FALSE, fig.width=6.75, fig.height = 3.5}
#fig_no <- 1
...
#### Fig. S2. Tables and their relationships in database of stormwater control measures in the Little Stringybark and Dobsons Creek catchments. Spatial tables can be identified by their geometry field.
...
#### Fig. S4. Maps of road (green) and property (orange) parcels of A. Little Stringybark Creek (LSC) and B. Dobsons Creek. .  
...
Property and road parcels were combined into a single spatial table, parcels (Fig. S4).   
...
#### Fig. S5. Maps of impervious areas of A. Little Stringybark Creek (LSC) and B. Dobsons Creek, coloured by drainage connection (see text).  
...
ft <- flextable::regulartable(tanksMetaData)
ft <- flextable::align(ft, align = "left", part = "all")
ft <- flextable::valign(ft, valign = "top", part = "all")
ft <- flextable::width(ft, width = dim(ft)$widths*6.25/(flextable::flextable_dim(ft)$widths))  #A4 wudth  with 2.5 cm 
...
ft <- flextable::regulartable(rgsMetaData)
ft <- flextable::align(ft, align = "left", part = "all")
ft <- flextable::valign(ft, valign = "top", part = "all")
ft <- flextable::width(ft, width = dim(ft)$widths*6.25/(flextable::flextable_dim(ft)$widths))  #A4 wudth  with 2.5 cm 
ft <- flextable::autofit(ft)
...
```{r, out.width=7, include=TRUE, fig.align="center", echo=FALSE, fig.width = 6.75, fig.height = 5.3}
#flow chart generated in above chunk in Rstudio, and printed to pdf.
knitr::include_graphics("images/functions_diag.pdf")
```

#### Fig. S3-7. Primary functions in BACRIfunctions.R (and modelfunctions2017.R in the case of tankmodel and gardenmodel) and the flow of calculations to achieve the primary outputs of budget_subc_time_series and EI_subc_time_series.
...
#system.time(
  budget_29 <- budget_subc_time_series(pipeID = 29, runoffData = lsc_runoff)#) #~ 12 min
