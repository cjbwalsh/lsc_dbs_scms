...
S3 describes compilation of specification data for stormwater control measures (SCMs) implemented in the Little Stringybark Creek and Dobsons Creek catchments. The data was structured as a postgreSQL database. The database's constituent tables have been compiled into two files in the data directory of the github repository https://github.com/cjbwalsh/lsc_dbs_scms (db_non_sf.rda, containing the non-spatial tables, and db_sf.zip, containing the spatial tables each saved as a geopackage file), and the code in this document assumes it is running from a clone of that repository.  
