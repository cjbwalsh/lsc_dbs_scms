...
sim_set$y <- sim_set$y + (sim_set$lei_s1 + 1.05)*sim_set$t/(76*2)
# ~0.25% increase per year for LYR - ei = 0% lei_s1 = -1: 10^(0.05*4/(76*2.5))
# ~12% increase per year for BRS  - ei = 21.8% lei_s1 = 1.337589: 10^((1.05 + 1.337829)*4/(76*2.5))
...
par(mar = c(2,4,1,1))
plot(c(-2,2),c(0.5,2.5), type = 'n', ylab = "", xlab = "", axes = 0)
...
par(mar = c(2,4,1,1))
plot(temp$x, temp$`50%`, ylim = c(-3.25,0.75), pch = 21, bg = temp$col, 
