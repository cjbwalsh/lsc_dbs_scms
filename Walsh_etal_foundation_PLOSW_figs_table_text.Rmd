...
Despite several campaigns of community engagement, which overcame many barriers to community particpation, SCMs were installed on only 28% of the private properties with drainage connection in the L4 catchment  [@bos_brown_2015]: this number grew to `r round(100*L4_prop_target_props)`% in the following 4 years, because of a planning provision placed on the catchment [@gov_vic_2019].  Two subsequent engagement rounds in the D8 catchment achieved SCMs on `r round(100*D8_prop_target_props)`% of the connected properties.  

```{r}
load("data/scmProjects_EB.rda")
lsc_eb <- scmProjects_EB[scmProjects_EB$pipeID < 100 & 
                        !grepl("RN-",scmProjects_EB$projectID) & 
                        !grepl("RE-",scmProjects_EB$projectID),]
...
#pdf("images/Fig3_effectiveness.pdf", width = 6, height = 5)
...
#pdf("images/Fig4_site_trends.pdf", width = 7, height = 4)
...
#pdf("images/Fig5_ES1_delES.pdf", width = 7, height = 2.5)
