...
Fig. 2.  The 11 streamflow-gauging sites considered in this paper and their catchments, coloured by their status as control, experimental or reference. The 7 primary catchments of the original experiment are italicized. Impervious areas in each catchment are shaded by their connection to the stormwater drainage system in 2019. (Impervious areas outside catchments are not shown.)  Inset maps show the location of the main map (grey rectangle) in Victoria, Australia.  
