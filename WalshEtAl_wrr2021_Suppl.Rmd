...
Fig. S`r fig_no`a shows the models assume no impervious runoff from the subcatchment before sealing and piping of Wattle Valley Road in 2006, and a reduction in impervious runoff leaving the catchment following installation of SCMs in the subcatchmnent. Fig. SS`r fig_no`a, shows that the frequency of overflow from the terminal SCM in this subcatchment was reduced to ~12 rain events per year, which is sufficient for the runoff frequency (RO) sub-index to achieve a perfect score, leading to EI~RO~ being near-zero in Fig. `r fig_no`a.  
